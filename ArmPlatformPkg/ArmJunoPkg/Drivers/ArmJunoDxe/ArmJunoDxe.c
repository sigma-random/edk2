...
// Ethernet device : " sky2.mac_address=11.22.33.44.55.66.77.88"
//
#define SKY2_MAC_ADDRESS_BOOTARG_LEN  41
  ...
  )
{
  ...
  UnicodeSPrint (
    ...
    L"%s sky2.mac_address=%02x.%02x.%02x.%02x.%02x.%02x.%02x.%02x",
    DefaultBootArgument,
    (SysPciGbeH >> 24) & 0xFF, (SysPciGbeH >> 16) & 0xFF,
