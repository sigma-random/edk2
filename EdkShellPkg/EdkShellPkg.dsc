...
[Components]
  $(EDK_SHELL_DIR)/Shell.inf {
    <BuildOptions>
      ...
      ARM:*_*_AARCH64_CC_FLAGS     = -DEFI_MONOSHELL
      ARM:*_*_AARCH64_VFRPP_FLAGS  = -DEFI_MONOSHELL
      ARM:*_*_AARCH64_APP_FLAGS    = -DEFI_MONOSHELL
      ARM:*_*_AARCH64_PP_FLAGS     = -DEFI_MONOSHELL
  }
  ...
  $(EDK_SHELL_DIR)/ShellFull.inf {
    <BuildOptions>
      ...
      ARM:*_*_AARCH64_CC_FLAGS     = -DEFI_MONOSHELL -DEFI_FULLSHELL
      ARM:*_*_AARCH64_VFRPP_FLAGS  = -DEFI_MONOSHELL -DEFI_FULLSHELL
      ARM:*_*_AARCH64_APP_FLAGS    = -DEFI_MONOSHELL -DEFI_FULLSHELL
      ARM:*_*_AARCH64_PP_FLAGS     = -DEFI_MONOSHELL -DEFI_FULLSHELL
  }
...
[BuildOptions.Common.EDK]
  ...
  ARM:*_*_AARCH64_CC_FLAGS     = -DEFIAARCH64 $(GCC_MACRO)
  ARM:*_*_AARCH64_VFRPP_FLAGS  = -DEFIAARCH64 $(GCC_MACRO)
  ARM:*_*_AARCH64_APP_FLAGS    = -DEFIAARCH64 $(GCC_MACRO)
  ARM:*_*_AARCH64_PP_FLAGS     = -DEFIAARCH64 $(GCC_MACRO)
